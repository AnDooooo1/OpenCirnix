...
namespace Cirnix.Forms.Update
{
    ...
    {
        public static readonly string HistoryURL = "https://github.com/AnDooooo1/OpenCirnix/releases";
        ...
        {
            string result = Globals.GetStringFromServer("https://api.github.com/repos/AnDooooo1/OpenCirnix/releases");
