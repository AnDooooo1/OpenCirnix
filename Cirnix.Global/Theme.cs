...
namespace Cirnix.Global
{
    public static class Theme
    {
        ...
        public static string Title { get; private set; } = "Bobby";

        public static string MsgTitleColor { get; set; } = "|CFF7070CC";

        public static string MsgTitle { get; set; } = "「Bobby」";

        public static string MsgColor { get; set; } = "|CFF7070CC";
